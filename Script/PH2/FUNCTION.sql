...
BEGIN
   IF(USEROLE LIKE 'Nhân viên') THEN
        BEGIN
            ...
            END IF; 
        END;
    ELSIF(USEROLE LIKE 'Qu?n lý tr?c ti?p') THEN
        BEGIN
            ...
            END IF; 
        END;
    ELSIF(USEROLE LIKE 'Tr??ng phòng') THEN
        BEGIN
    ...
    ELSIF(USEROLE LIKE 'Tài chính') THEN
        BEGIN
            ...
            END IF; 
        END;
     ELSIF(USEROLE LIKE 'Nhân s?') THEN
        BEGIN
            ...
            END IF; 
        END;
    ELSIF(USEROLE LIKE 'Tr??ng ?? án') THEN
        BEGIN
...
END;
/
-- FUNCTION T?O PROJECTID KHI ADD
